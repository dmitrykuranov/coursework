...
@fstr9 = internal constant [5 x i8] c"%i \0A\00"
@fstr10 = internal constant [5 x i8] c"%i \0A\00"
@fstr11 = internal constant [5 x i8] c"%i \0A\00"
@fstr12 = internal constant [5 x i8] c"%i \0A\00"

; Function Attrs: nounwind
define void @main()  {
entry:
  %.9 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr1, i64 0, i64 0), i32 1)
  %.20 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr2, i64 0, i64 0), i32 3)
  %.27 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr3, i64 0, i64 0), i32 3)
  %.38 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr4, i64 0, i64 0), i32 9)
  %.45 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr5, i64 0, i64 0), i32 5)
  %.56 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr6, i64 0, i64 0), i32 15)
  %.63 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr7, i64 0, i64 0), i32 7)
  %.74 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr8, i64 0, i64 0), i32 21)
  %.81 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr9, i64 0, i64 0), i32 9)
  %.92 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr10, i64 0, i64 0), i32 27)
  %.105 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr11, i64 0, i64 0), i32 100)
  %.112 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fstr12, i64 0, i64 0), i32 -60)
  ret void
}
